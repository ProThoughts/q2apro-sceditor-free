		...
		function admin_form(&$qa_content) {
			...
			*/
			...
			$fields[] = array(
				...
				'label' => 'Enable Mathjax LaTeX-parsing in preview window (<span style="color:#F00;">only premium</span>)',
			...
			$fields[] = array(
				'type' => 'checkbox',
				'label' => 'Allow uploads of files (<span style="color:#F00;">only premium</span>)',
