...
*/
	...
	class qa_html_theme_layer extends qa_html_theme_base {
		...
		function head_script(){
			...
			// this is for our statistics, see license.txt
			if($this->request=='admin/plugins') {
				if( !(qa_opt('q2apro_sceditor_installed')) ) {
					$this->output('<script src="http://www.q2apro.com/tools/installed.php?dom='.$_SERVER['SERVER_NAME'].'&amp;id=70" type="text/javascript"></script>');					
					qa_opt('q2apro_sceditor_installed', 1);
				}
			}
		}
